...
You configure which network interface you want to view the bandwidth. the most common interfaces are `eth0` for a wired connection and `wlan0` for a wireless connection.
